...
<div className="container">
  ...
  <tbody>
    ...
    <ImageUpload />
    {/* <button class="btn btn-outline-info" onClick={handleClick} >Get Appointment</button> */}
    {/* <div>
      ...
      <div id="inputFields" style={{marginTop: '26px'}}>
        ...
        {searchType === 'symptomName' && (
          <div>
            ...
            <input type="text" id="symptomName" name="symptomName" placeholder='Enter symptom name'/>
          </div>
        )}
