      ...
      <div id="inputFields" style={{marginTop: '26px'}}>
        {searchType === 'medicineName' && (
          <div>
            ...
            <input type="text" id="medicineName" name="medicineName" value={message} onChange={handleInputChange} placeholder='Enter medicine name' />
        ...
        {searchType === 'symptomName' && (
          <div>
            ...
            <input type="text" id="symptomName" name="symptomName" value={message} onChange={handleInputChange} placeholder='Enter symptom name'/>
            <button onClick={handleSubmit}>Upload</button> 
          </div>
        )}
        ...
        {searchType === 'uploadImage' && (
          <div>
            ...
            <input type="file" id="imageUpload" name="imageUpload"  onChange={handleFileChange}/>
            <button onClick={handleUpload}>Upload</button> 
          </div>
        )}
      </div>
